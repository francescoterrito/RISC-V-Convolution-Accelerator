...
module conv1d_control_reg_top #(
  ...
  logic control_accumulate_qs;
  logic control_accumulate_wd;
  logic control_accumulate_we;
  ...
  prim_subreg #(
    ...
    .SWACCESS("RW"),
    .RESVAL  (1'h0)
  ) u_control_accumulate (
    .clk_i   (clk_i    ),
    .rst_ni  (rst_ni  ),

    // from register interface
    .we     (control_accumulate_we),
    .wd     (control_accumulate_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.control.accumulate.q ),

    // to register interface (read)
    .qs     (control_accumulate_qs)
  );
  ...
  assign control_accumulate_we = addr_hit[0] & reg_we & !reg_error;
  assign control_accumulate_wd = reg_wdata[1];
  ...
  always_comb begin
    ...
    unique case (1'b1)
      addr_hit[0]: begin
        ...
        reg_rdata_next[1] = control_accumulate_qs;
      end
